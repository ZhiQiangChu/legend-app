...
import cn.com.dplus.project.utils.MD5Util;
...
public class GUIDUtil {
    ...
    public static long getWorkerId() {
        ...
        hostName = "sondon";
        byte[] md5 = MD5Util.getMD5(hostName).getBytes();
    ...
    public static void main(String[] args) {
        ...
        GUIDUtil customUUID = new GUIDUtil(random.nextInt(2 ^ 10));
        for (int i = 0; i < 100; i++) {
            System.out.println(customUUID.generate());
        }
